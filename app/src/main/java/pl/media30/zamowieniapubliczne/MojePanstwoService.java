...
public interface MojePanstwoService {
    ...
    void najwiekszeZamowienia(@Query("conditions[zamowienia_publiczne.zamawiajacy_miejscowosc]") String miejscowosc, @Query("conditions[zamowienia_publiczne.zamawiajacy_wojewodztwo]") String wojewodztwo ,@Query("conditions[zamowienia_publiczne.zamawiajacy_kod_poczt]") String kod_pocztowy, @Query("conditions[zamowienia_publiczne.zamawiajacy_nazwa]") String nazwa, @Query("conditions[zamowienia_publiczne.zamawiajacy_regon]") String regon, @Query("conditions[zamowienia_publiczne.zamawiajacy_www]") String zamaw_www, @Query("conditions[zamowienia_publiczne.zamawiajacy_email]") String zamaw_email, @Query("q") String glowne_zapyt,  Callback<BaseListClass> cbx);
}
