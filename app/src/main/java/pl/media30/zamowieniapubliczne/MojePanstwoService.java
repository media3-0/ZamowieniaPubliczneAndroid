...
public interface MojePanstwoService {
    ...
    * */
    ...
    @GET("/dataset/zamowienia_publiczne/search?limit=50")
    ...
    @GET("/dataset/zamowienia_publiczne/search?order=zamowienia_publiczne.wartosc_cena%20desc&fields[]=zamowienia_publiczne.id&fields[]=zamowienia_publiczne.wartosc_cena&fields[]=zamowienia_publiczne.zamawiajacy_nazwa&limit=50")
